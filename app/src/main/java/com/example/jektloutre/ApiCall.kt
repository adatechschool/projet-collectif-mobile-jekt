...
class ApiCall {
    ...
    fun getmessages(context: Context, callback: (DataModel) -> Unit) {

        // Create a Retrofit instance with the base URL and
        // a GsonConverterFactory for parsing the response.
        val retrofit: Retrofit = Retrofit.Builder().baseUrl("http://localhost:8080/").addConverterFactory(
        ...
        val call: Call<DataModel> = service.getmessages()
        ...
        call.enqueue(object : Callback<DataModel> {
            ...
            override fun onResponse(response: Response<DataModel>?, retrofit: Retrofit?) {
                ...
                if(response!!.isSuccess){
                    ...
                    val messages: DataModel = response.body() as DataModel
